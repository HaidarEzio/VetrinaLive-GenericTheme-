  ...
  return (
    <div className={classes.root}>
      ...
      <main className={classes.main}>
        ...
        <Products t={t} mayFetch={mayFetch} limit={8} shop={shop} hasNextPage={hasNextPage} {...productsProps}>
...
const oneProduct = {
  ...
  description: '{"blocks":[{"key":"75ff5","text":"","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}}],"entityMap":{}}',
  shop_id: 922,
...
Layout.defaultProps = {
  ...
  shop: {
    ...
    categories: [
      { id: 465, title: "APPETIZER", color: "#2196f3", order: 5 },
      { id: 464, title: "SALAD", color: "#f57c00", order: 4 },
      { id: 463, title: "MAIN DISH", color: "#673ab7", order: 3 },
      { id: 462, title: "DRINK", color: "#e91e63", order: 2 },
      { id: 461, title: "ALL CATEGORIES", color: "#00bcd4", order: 1 },
    ],
    country_code: "UA",
    fiscal_code: "123123",
    locale: "en",
  ...
  productsProps: {
    products: [oneProduct, oneProduct, oneProduct, oneProduct, oneProduct, oneProduct, oneProduct, oneProduct],
    total: 8,
    has_next_page: true,
  },
  featuredProduct: [oneProduct, oneProduct, oneProduct, oneProduct, oneProduct, oneProduct, oneProduct],
};
